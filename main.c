...

{
    ...
    int ch;
    printf("\n\n\t====================================\n");
    printf("\t   -COP'S FIR RECORD MANAGEMENT-\n");
    printf("\t====================================");
    ...
    while(1)
    {
        ...
        case 6:
        	system("cls");
            printf("\n\n\t\tTHANK YOU,A MINI PROJECT BY MIRYALA ROHITH AND CHARVEE KRISHNA.....!!! \n\n ");
            getch();
            exit(0);
    ...
    do
{
	...
	{
	printf("  \n\n\n    WELCOME TO COP'S FIR RECORD MANAGEMENT SYSTEM !! YOUR LOGIN IS SUCCESSFUL");
